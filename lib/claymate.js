	...
	this.install = function(opts) {
		...
		if (filesInWorkingDir.length) {
			...
			var readline = require('readline'),
				...
				message = "The current directory is not empty. Results of this operation will likely be hard to sort out if you don't know what you're doing. Would you like to continue? [y/N] ";
